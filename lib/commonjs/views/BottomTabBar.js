...
class TabBarBottom extends React.Component {
  constructor(...args) {
    ...
    _defineProperty(this, "_getKeyboardAnimationConfigByType", type => {
      ...
      const keyboardAnimationConfig = (keyboardHidesTabBarAnimationConfig === null || keyboardHidesTabBarAnimationConfig === void 0 ? void 0 : keyboardHidesTabBarAnimationConfig[type]) || defaultKeyboardAnimationConfig;
  ...
  render() {
    ...
    const tabBarStyle = [{
      height: height != null ? typeof height === 'number' ? height + insets.bottom : height :
...
var _default = exports.default = (0, _withDimensions.default)(TabBarBottom);
